...
//Admin, 000000
//Moder, 123123
//остальные забыл, пу-пу-пу

//кнопка изменить - желтый
// back to home - выглядит как скам


//TODO:
// Фильтрация юзеров
// допилить формирование отчетов из окна поиска (не передается массив тасок из html-ки)
// подверстать окно фильтрации в поиске тасок
